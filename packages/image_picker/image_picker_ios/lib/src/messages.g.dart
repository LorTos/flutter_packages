...
class MediaSelectionOptions {
  ...
  static MediaSelectionOptions decode(Object result) {
    ...
    return MediaSelectionOptions(
      ...
      selectionLimit: result[4] as int?,
    );
  }
}
...
class ImagePickerApi {
  ...
  Future<List<String?>?> pickMultiImage(MaxSize arg_maxSize, int? arg_imageQuality, bool arg_requestFullMetadata, int? arg_selectionLimit) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.ImagePickerApi.pickMultiImage', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_maxSize, arg_imageQuality, arg_requestFullMetadata, arg_selectionLimit]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',

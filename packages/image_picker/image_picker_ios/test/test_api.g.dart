...
abstract class TestHostImagePickerApi {
  ...
  Future<List<String?>?> pickMultiImage(MaxSize maxSize, int? imageQuality, bool requestFullMetadata, int? selectionLimit);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          ...
          final int? arg_selectionLimit = (args[3] as int?);
          final List<String?>? output = await api.pickMultiImage(arg_maxSize!, arg_imageQuality, arg_requestFullMetadata!, arg_selectionLimit);
          return <Object?>[output];
        });
      }
    }
